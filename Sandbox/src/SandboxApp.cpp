...
{
public:
	ExampleLayer() :Layer("Example") ,m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_SquarePosition(0.0f)
	{
		...
		Hazel::BufferLayout layout = {
				{"a_Position", Hazel::ShaderDataType::Float3, true},
				{"a_Color", Hazel::ShaderDataType::Float4, true}
		};
		...
		squareIB.reset(Hazel::IndexBuffer::Create(squaredIndices, sizeof(squaredIndices) / sizeof(uint32_t)));
	...
	void OnUpdate(Hazel::TimeStep timestep) override
	{
		...
		for (int y = 0; y < max_N; ++y)
		{
			...
			{
				glm::vec3 pos(x * 0.11f - max_N / 2 * 0.11f, y * 0.11f - max_N / 2 * 0.11f, 0.0f);
